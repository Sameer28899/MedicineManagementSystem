<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="Homepage.aspx.cs" Inherits="MedicineManagementSystem.Homepage" EnableEventValidation="false"%>
        ...
        <div class="row align-items-center">
            <div class="col-lg-7">
                <div class="hero-content">
                    ...
                    <asp:LinkButton class="main-btn main-btn-2" ID="LinkButton" runat="server">Search Medicine</asp:LinkButton>
                </div>        
            </div>
        </div>
    </div>
        ...
        <div class="row">
            <div class="col-lg-6">
                <div class="overview-content">
                    ...
                    <asp:LinkButton class="main-btn" ID="LinkButton1" runat="server">About Us</asp:LinkButton>
