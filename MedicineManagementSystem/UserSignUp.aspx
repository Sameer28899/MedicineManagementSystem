 <%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="UserSignUp.aspx.cs" Inherits="MedicineManagementSystem.UserSignUp" enableEventValidation="false" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                         <div class="col">
                            <center>
                               <div class="form-group">
                                  <asp:LinkButton ID="LinkButton1" class="btn btn-outline-success btn-lg btn-block"  runat="server" OnClick="LinkButton1_Click">Sign Up</asp:LinkButton>
                               </div>
                            </center>
                         </div>
                        </div>
