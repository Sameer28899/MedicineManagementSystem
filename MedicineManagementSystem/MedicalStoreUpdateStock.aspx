<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="MedicalStoreUpdateStock.aspx.cs" Inherits="MedicineManagementSystem.WebForm4" EnableEventValidation="false" %>
            ...
            <div class="col-md-9">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col">
                                <center><h4>Update Stock</h4></center>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        ...
                                        <asp:Button ID="Button1" runat="server" class="btn btn-primary ml-1" Text="Go" OnClick="Button1_Click" />
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="TextBox10" CssClass="form-control" runat="server" ReadOnly="true" placeholder="Medicine Name"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="TextBox2" CssClass="form-control" runat="server" ReadOnly="true" placeholder="Company Name"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="TextBox5" CssClass="form-control" runat="server" placeholder="Description" ReadOnly="true" TextMode="MultiLine" Rows="3"></asp:TextBox>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                         <div class="col-md-6">
                            <center>
                               <div class="form-group">
                                  <asp:Button class="btn btn-outline-primary btn-block btn-lg" ID="Button4" runat="server" Text="Update" OnClick="Button4_Click" />      
                               </div>
                            </center>
                         </div>
                         <div class="col-md-6">
                            <center>
                               <div class="form-group">
                                  <asp:Button class="btn btn-outline-danger btn-block btn-lg" ID="Button2" runat="server" Text="Delete Permanently" OnClick="Button2_Click" />      
                               </div>
                            </center>
                         </div>
                        </div>
