...
{
    public partial class MedicalStoreMedicalReport : System.Web.UI.Page
    {
        ...
        {
            Response.Redirect("MedicalStoreEditProfile.aspx");
        }

        protected void LinkButton2_Click(object sender, EventArgs e)
        {
            Response.Redirect("MedicalStoreAddMedicine.aspx");
        }

        protected void LinkButton3_Click(object sender, EventArgs e)
        {
            Response.Redirect("MedicalStoreMedicineInventory.aspx");
        }

        protected void LinkButton4_Click(object sender, EventArgs e)
        {
            Response.Redirect("MedicalStoreUpdateStock.aspx");
        }
    }
}