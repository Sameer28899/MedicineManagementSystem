<%@ Page Title="" Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="AdminMemberManagement.aspx.cs" Inherits="MedicineManagementSystem.AdminUserManagement" %>
                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <div class="input-group">
                                        <asp:TextBox ID="TextBox11" CssClass="form-control mr-1" runat="server" placeholder="Member ID"></asp:TextBox>
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="TextBox1" CssClass="form-control" runat="server" ReadOnly="true" placeholder="Full Name"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                ...
                                <div class="form-group">
                                    <asp:TextBox ID="TextBox2" CssClass="form-control" runat="server" ReadOnly="true" TextMode="Date"></asp:TextBox>
                                </div>
                            </div>
                            <div class="col-md-4">
